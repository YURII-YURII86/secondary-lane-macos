...
def load_settings() -> Settings:
    ...
    workspace_roots = [Path(item.strip()).expanduser().resolve() for item in raw_roots.split(":") if item.strip()]
    ...
    return Settings(
        ...
        gui_allowed_apps=_json_list(env.get("GUI_ALLOWED_APPS_JSON", '["Google Chrome","Finder","Terminal","Visual Studio Code"]'), ["Google Chrome", "Finder", "Terminal", "Visual Studio Code"]),
